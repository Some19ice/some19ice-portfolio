    ...
    return (
        <div className={darkMode ? "dark" : ""}>
            ...
            <main className="bg-white dark:bg-gray-900 transition-colors duration-300">
                ...
                <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700">
                    <div className="max-w-7xl mx-auto px-6 lg:px-8">
                        <div className="flex justify-between items-center py-4">
                            <div
                                className="font-burtons text-2xl text-gray-900 dark:text-white"
                            ...
                            <div className="flex items-center space-x-6">
                                <button
                                    ...
                                    className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                                >
                                    <BsFillMoonStarsFill className="text-lg" />
                                </button>
                                <a
                                    href={config.resumeUrl}
                                    className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-teal-600 dark:hover:text-teal-400 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                                ...
                                <a
                                    ...
                                    className="px-6 py-2 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-lg font-medium hover:from-teal-600 hover:to-cyan-600 transition-all transform hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                                    ...
                                    innovative ideas and functional reality. Specializing in Web2 &
                                    Web3 technologies.
                                </p>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                                    <a
                                        ...
                                        className="px-8 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-lg font-medium hover:from-teal-600 hover:to-cyan-600 transition-all transform hover:scale-105 shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                                    ...
                                    <a
                                        href="#portfolio"
                                        className="px-8 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:border-teal-500 hover:text-teal-500 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                                ...
                                <div className="flex justify-center lg:justify-start space-x-6">
                                    <a
                                        ...
                                        className="text-gray-400 hover:text-teal-500 transition-colors transform hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded"
                                    >
                            ...
                            <div className="flex justify-center lg:justify-end">
                                <div className="relative">
                                    ...
                                    {/* Floating elements */}
                                    <div className="absolute -top-4 -right-4 w-20 h-20 bg-yellow-400 rounded-full flex items-center justify-center text-2xl motion-safe:animate-bounce">
                                        ⚡
                                    </div>
                                    <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-pink-400 rounded-full flex items-center justify-center text-xl motion-safe:animate-pulse">
                                        💻
                                    </div>
                                </div>
                            </div>
                ...
                {/* Portfolio Section */}
                <section id="portfolio" className="py-20 px-6 lg:px-8 scroll-mt-24">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">
                                Featured Projects
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                                ...
                                project represents a unique challenge and solution crafted with

...
export default function Home() {
  ...
  return (
      <div className={darkMode ? "dark" : ""}>
          <Head>
              <title>Some19ice Portfolio</title>
              <meta name="description" content="Generated by create next app" />
              <link rel="icon" href="/favicon.ico" />
          </Head>
          <main className=" bg-zinc-300 px-10 dark:bg-zinc-900 md:px-20 lg:px-40">
              <section className="min-h-screen">
                      ...
                      <ul className="flex items-center">
                          ...
                          <li>
                              <a
                                  ...
                                  href="https://www.linkedin.com/in/some19ice/"
                              >
                                  Resume
                              </a>
                          </li>
                  ...
                  <div className="text-center p-10 py-10">
                      ...
                      <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
                          ...
                          <a href="https://www.linkedin.com/in/some19ice/">
                              <AiFillLinkedin />
                          </a>
                          <a href="https://github.com/some19ice">
                              <AiFillGithub />
                          </a>
                      </div>
              ...
              <section>
                  <div>
                      ...
                      <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
                          ...
                          and collaborated with talanted people to create digital products for both

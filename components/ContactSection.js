                        ...
                        <div className="pt-6">
                            ...
                            <div className="flex space-x-4">
                                <a
                                    ...
                                    className="bg-gray-100 dark:bg-gray-800 p-3 rounded-full hover:bg-teal-100 dark:hover:bg-teal-900 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
                        ...
                        <div className="space-y-4">
                            <a
                                ...
                                className="block w-full bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-6 py-3 rounded-md text-center font-medium hover:from-cyan-600 hover:to-teal-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="block w-full border-2 border-teal-500 text-teal-500 px-6 py-3 rounded-md text-center font-medium hover:bg-teal-500 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
